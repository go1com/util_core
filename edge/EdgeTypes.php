...
class EdgeTypes
{
    ...
    const HAS_SUGGESTED_COMPLETION    = 44; # T: 0 or gc_ro.id        | S: gc_lo.id              | data: { KEY: VALUE } | target_id is 0 unless lo is reused, then target_id is gc_ro.id of parent lo
